...
type HandlerFunc func(ctx context.Context, vars map[string]string, userId int64, update tele.Update) error
...
func (r *Router) Execute(ctx context.Context, path string, userId int64, update tele.Update) error {
