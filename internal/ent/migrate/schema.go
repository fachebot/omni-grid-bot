...
var (
	...
	StrategiesColumns = []*schema.Column{
		...
		{Name: "symbol", Type: field.TypeString, Size: 32},
		{Name: "account", Type: field.TypeString},
		{Name: "mode", Type: field.TypeEnum, Enums: []string{"neutral", "long", "short"}},
		...
		Indexes: []*schema.Index{
			{
				...
				Unique:  false,
				Columns: []*schema.Column{StrategiesColumns[4], StrategiesColumns[6]},
			},
			{
				Name:    "strategy_exchange_symbol_account",
				Unique:  true,
				Columns: []*schema.Column{StrategiesColumns[4], StrategiesColumns[5], StrategiesColumns[6]},
			},
		},
	}
