...
func (_q *GridQuery) All(ctx context.Context) ([]*Grid, error) {
	...
	return withInterceptors[[]*Grid](ctx, _q, qr, _q.inters)
}
...
func (_q *GridQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = _q.Select(grid.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *GridQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*GridQuery](), _q.inters)
}
...
func (_q *GridQuery) Clone() *GridQuery {
	...
	return &GridQuery{
		config:     _q.config,
		ctx:        _q.ctx.Clone(),
		order:      append([]grid.OrderOption{}, _q.order...),
		inters:     append([]Interceptor{}, _q.inters...),
		predicates: append([]predicate.Grid{}, _q.predicates...),
...
func (_q *GridQuery) Select(fields ...string) *GridSelect {
	...
	sbuild := &GridSelect{GridQuery: _q}
...
func (_q *GridQuery) prepareQuery(ctx context.Context) error {
...
func (_q *GridQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Grid, error) {
	var (
		nodes = []*Grid{}
		_spec = _q.querySpec()
	)
...
func (_q *GridQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *GridQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *GridQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *GridGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*GridQuery, *GridGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *GridGroupBy) sqlScan(ctx context.Context, root *GridQuery, v any) error {
...
func (_s *GridSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*GridQuery, *GridSelect](ctx, _s.GridQuery, _s, _s.inters, v)
}

func (_s *GridSelect) sqlScan(ctx context.Context, root *GridQuery, v any) error {
